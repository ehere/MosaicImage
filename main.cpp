...
int main(int argc, char** argv){
    ...
    p.out_folder = "pixels/";
    //pixel_size
    p.pixelSize = Size(50, 50);
    //input image
    p.input_image = "nature.jpg";
    //resize
    p.resize_x = 0.1;
    p.resize_y = 0.1;
    //pixelize
    ...
    fs::path dir(p.out_folder);
    if(fs::create_directory(p.out_folder)){
        std::cerr<< "Directory Created: "<< p.out_folder <<std::endl;
    }
